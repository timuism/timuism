...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, lazyEventHandler, getQuery as getQuery$1, getCookie, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, getResponseStatusText } from 'file:///Users/tim/www/timuism/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/tim/www/timuism/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/tim/www/timuism/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/tim/www/timuism/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/tim/www/timuism/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/tim/www/timuism/node_modules/ofetch/dist/node.mjs';
import destr, { destr as destr$1 } from 'file:///Users/tim/www/timuism/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/tim/www/timuism/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/tim/www/timuism/node_modules/hookable/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///Users/tim/www/timuism/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/tim/www/timuism/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file:///Users/tim/www/timuism/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/tim/www/timuism/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file:///Users/tim/www/timuism/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/tim/www/timuism/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/tim/www/timuism/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/tim/www/timuism/node_modules/radix3/dist/index.mjs';
import { addClassToHast, getHighlighter, loadWasm } from 'file:///Users/tim/www/timuism/node_modules/shikiji/dist/index.mjs';
import { transformerNotationDiff, transformerNotationFocus, transformerNotationHighlight, transformerNotationErrorLevel } from 'file:///Users/tim/www/timuism/node_modules/shikiji-transformers/dist/index.mjs';
import { extname } from 'file:///Users/tim/www/timuism/node_modules/pathe/dist/index.mjs';
import { unified } from 'file:///Users/tim/www/timuism/node_modules/unified/index.js';
import { toString as toString$1 } from 'file:///Users/tim/www/timuism/node_modules/mdast-util-to-string/index.js';
import { postprocess, preprocess } from 'file:///Users/tim/www/timuism/node_modules/micromark/dev/index.js';
import { stringifyPosition } from 'file:///Users/tim/www/timuism/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///Users/tim/www/timuism/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///Users/tim/www/timuism/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///Users/tim/www/timuism/node_modules/micromark-util-resolve-all/index.js';
import { normalizeUri } from 'file:///Users/tim/www/timuism/node_modules/micromark-util-sanitize-uri/dev/index.js';
import slugify from 'file:///Users/tim/www/timuism/node_modules/slugify/slugify.js';
import remarkParse from 'file:///Users/tim/www/timuism/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///Users/tim/www/timuism/node_modules/remark-rehype/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///Users/tim/www/timuism/node_modules/remark-mdc/dist/index.mjs';
import { toString } from 'file:///Users/tim/www/timuism/node_modules/hast-util-to-string/index.js';
import Slugger from 'file:///Users/tim/www/timuism/node_modules/github-slugger/index.js';
import { detab } from 'file:///Users/tim/www/timuism/node_modules/detab/index.js';
import remarkEmoji from 'file:///Users/tim/www/timuism/node_modules/remark-emoji/index.js';
import remarkGFM from 'file:///Users/tim/www/timuism/node_modules/remark-gfm/index.js';
import rehypeExternalLinks from 'file:///Users/tim/www/timuism/node_modules/rehype-external-links/index.js';
import rehypeSortAttributeValues from 'file:///Users/tim/www/timuism/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///Users/tim/www/timuism/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///Users/tim/www/timuism/node_modules/rehype-raw/index.js';
import { version, unref } from 'file:///Users/tim/www/timuism/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/tim/www/timuism/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/tim/www/timuism/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/tim/www/timuism/server/assets"}];
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/Users/tim/www/timuism/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/tim/www/timuism/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/tim/www/timuism","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/tim/www/timuism/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/tim/www/timuism/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/tim/www/timuism/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/tim/www/timuism/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const parseMarkdown = async (md, opts = {}) => {
  if (!moduleOptions) {
    moduleOptions = await import(
      'file:///Users/tim/www/timuism/.nuxt/mdc-imports.mjs'
      /* @vite-ignore */
    ).catch(() => ({}));
  }
...
const _litdBt = lazyEventHandler(async () => {
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///Users/tim/www/timuism/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _GP5opB = defineEventHandler(async (event) => {
...
const _DaGz5I = defineEventHandler(async (event) => {
...
const _jiEwel = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_AhGmVp = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_AhGmVp, lazy: true, middleware: false, method: undefined },
  { route: '/api/_mdc/highlight', handler: _litdBt, lazy: false, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _GP5opB, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _GP5opB, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _GP5opB, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _DaGz5I, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _jiEwel, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _jiEwel, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _jiEwel, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_AhGmVp, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Users/tim/www/timuism/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/tim/www/timuism/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
